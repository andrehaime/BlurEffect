...
imagem abrir_imagem_P(char *nome_do_arquivo) {
  FIBITMAP *bitmapIn;
  int x, y;
  RGBQUAD color;
  imagem I;
...
void liberar_imagem_P(imagem *I) {
  munmap(I->r, I->width*I->height);
  munmap(I->g, I->width*I->height);
  munmap(I->b, I->width*I->height);
}
